...
router.route('/mpsearch')
        .get(controller.mpsearch)
        .post(controller.addmpsearch)
router.route('/mpsearch/delete')
        .get(controller.delmpsearch)
        .post(controller.deletempsearch)
router.route('/mpsearch/update')
        .get(controller.updmpsearch)
        .post(controller.updatempSearch)
router.route('/vpsearch')
        .get(controller.vpsearch)
        .post(controller.addvpsearch)
router.route('/vpsearch/delete')
        .get(controller.delvpsearch)
        .post(controller.deletevpsearch)
router.route('/vpsearch/update')
        .get(controller.updvpsearch)
        .post(controller.updatevpSearch)
